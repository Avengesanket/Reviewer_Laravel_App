...
<div class="min-h-[80vh] flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center mb-6">
        ...
        <h2 class="mt-4 text-3xl font-extrabold text-gray-900">Sign in to your journal</h2>
    </div>

    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow-xl shadow-gray-200/50 sm:rounded-2xl sm:px-10 border border-gray-100">
            @if($errors->any())
                <div class="mb-4 bg-red-50 text-red-500 text-sm p-3 rounded-lg border border-red-100 flex items-center gap-2">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="email" name="email" type="email" autocomplete="email" required 
                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="password" name="password" type="password" minlength="6" maxlength="16" autocomplete="current-password" required 
                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition">
                    </div>
                </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-1 gap-3">
                    <a href="{{ route('register') }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition">
                        Create an account
                    </a>
                </div>
            </div>
