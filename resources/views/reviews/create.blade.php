...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('reviews.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" maxlength="50" value="{{ old('title') }}" class="w-full border p-2 rounded">
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="text" name="genre" maxlength="50" value="{{ old('genre') }}" class="w-full border p-2 rounded">
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="number" name="rating" min="1" max="10" value="{{ old('rating') }}" class="w-full border p-2 rounded">
            </div>
            <div>
                <label class="block font-bold mb-1">Date Consumed</label>
                <input type="date" name="consumed_at" value="{{ old('consumed_at') }}" class="w-full border p-2 rounded">
            </div>
        </div>

        <div class="mb-4">
            <label class="block font-bold mb-1">Review</label>
            <textarea name="body" rows="4" maxlength="150" class="w-full border p-2 rounded">{{ old('body') }}</textarea>
        </div>
